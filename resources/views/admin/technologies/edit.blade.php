        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Technology <i class="feather icon-move"></i></h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form method="POST" id="technologiesUpdateForm" action="{{ route('admin.technologies.update', $data->id) }}" class="number-tab-steps wizard-circle" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <fieldset>
                                <div class="row">
                                        ...
                                        <div class="form-group mb-0 d-flex flex-column-reverse align-items-start justify-content-center">
                                            ...
                                            <div class="cross-container d-flex">
                                                @if(isset($data->image)  && $data->image !== '' )
                                                    <img id="preview" src="{{ asset(uploadsDir('technologies') . $data->image) }}" alt="Background Picture Preview" class="d-inline-flex rounded-lg" height="80" width="80">
                                                @else
...
@section('footer-js')
    ...
    $(document).ready(function() {
        ...
        $('#technologiesUpdateForm').validate({
            rules: {
                title: {
                    required: true,
                },
