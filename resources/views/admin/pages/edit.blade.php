                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" maxlength="65000" rows="5" class="form-control">{{ old('content', $data->content) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="meta_description" maxlength="65000" rows="5" class="form-control">{{ old('meta_description', $data->meta_description) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
