        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Achievement <i class="feather icon-sliders"></i></h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form method="POST" id="newsUpdateForm" action="{{ route('admin.achievements.update', $data->id) }}" class="number-tab-steps wizard-circle" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <fieldset>
                                <div class="row">
