        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form method="POST" id="privacy-policy" action="{{ route('admin.content-pages.privacyUpdate', $record->id) }}" class="number-tab-steps wizard-circle" enctype="multipart/form-data">
                            <input type="hidden" name="page_identifier" value="privacy-policy">
                            @csrf
                            @method('PUT')
                            <fieldset>
                                <div class="row">
