                        ...
                        <div class="row">
                           <div class="col-sm-6">
                              <div class="form-group">
                                 <label for="meta_title" style="margin-bottom:4px !important;">Select Page Template</label>
                     ...
                     <div id="servicesFields">
                           ...
                           <div class="row flex-column">
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="title" name="title" maxlength="190" value="{{ old('title') }}" class="form-control">
                           ...
                           <div class="row flex-column">
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    ...
                                    <input type="file" name="icon" class="image-holder form-control p-6">
                                 </div>
                              </div>
                           </div>
                           <div class="row flex-column">
                        ...
                        <fieldset class="mt-1">
                           <div class="row">
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    <label for="working_process_to_show">Which Working Process record do you want to show?</label>
                                    <select class="form-control" id="working_process_to_show" name="working_process_to_show" >
                           ...
                           <div class="row">
                              <div class="col-sm-6">
                                 <div class="form-group mb-1">
                                    ...
                                    <select class="form-control" name="industries_to_show[]" id="industries_to_show" multiple>
                           ...
                           <div class="row">
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    ...
                                    <select class="form-control" multiple id="technologies_to_show" name="technologies_to_show[]">
                           ...
                           <div class="row">
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    ...
                                    <select class="form-control" multiple id="st_testimonials_to_show" name="st_testimonials_to_show[]">
                     ...
                     <div id="homeFields">
                        <fieldset>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="meta_title" style="margin-bottom:4px !important;">Select Services</label>
                                        <div class="custom-control custom-switch custom-switch-success mb-1">
                                            <select class="form-control" multiple id="services_to_show" name="services_to_show[]">
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="meta_title" style="margin-bottom:4px !important;">Select Achievements</label>
                                        <div class="custom-control custom-switch custom-switch-success mb-1">
                                            <select class="form-control" multiple id="achievements_to_show" name="achievements_to_show[]">
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="meta_title" style="margin-bottom:4px !important;">Select Testimonials</label>
                                        <div class="custom-control custom-switch custom-switch-success mb-1">
                                            <select class="form-control" multiple id="ht_testimonials_to_show" name="ht_testimonials_to_show[]">
                                                @foreach($testimonials as $testimonial)
                                                <option value="{{ $testimonial }}">{{ $testimonial }}</option>
                                                @endforeach
                                            </select>
   ...
   $(document).ready(function(){
      ...
      function generateValidationRules(pageTemplate) {
         ...
         if (pageTemplate === 'services') {
            for (let i = 1; i <= 4; i++) {
                  ...
                  messages[`description_${i}`] = { required: "Textarea description" };
            }
         }
      ...
      $('#page_template').on('change', function () {
         ...
         if ($(this).val() === 'services') {
            $('#servicesFields').show();
            const { rules, messages } = generateValidationRules('services');
            // Apply validation rules for 'services' page template
            $('#pageForm').validate({ rules: rules, messages: messages });
